...
| `direct_recipient_id`                                               | *Optional[float]*                                                   | :heavy_minus_sign:                                                  | N/A                                                                 |
...
| models.TemplateCreateTemplateDirectLinkUnauthorizedError   | 401                                                        | application/json                                           |
| models.TemplateCreateTemplateDirectLinkForbiddenError      | 403                                                        | application/json                                           |
...
| models.TemplateDeleteTemplateDirectLinkUnauthorizedError   | 401                                                        | application/json                                           |
| models.TemplateDeleteTemplateDirectLinkForbiddenError      | 403                                                        | application/json                                           |
...
| models.TemplateToggleTemplateDirectLinkUnauthorizedError   | 401                                                        | application/json                                           |
| models.TemplateToggleTemplateDirectLinkForbiddenError      | 403                                                        | application/json                                           |
