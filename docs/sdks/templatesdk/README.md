...
* [~~template_get_many~~](#template_get_many) - Get multiple templates :warning: **Deprecated**
* [~~template_create_template_temporary~~](#template_create_template_temporary) - Create template :warning: **Deprecated**
