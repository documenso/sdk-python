...
class DocumentCreateDocumentTemporaryTypeSignature(str, Enum):
    SIGNATURE = "SIGNATURE"
...
class DocumentCreateDocumentTemporaryDistributionMethodRequest(str, Enum):
...
class DocumentCreateDocumentTemporaryEmailSettingsRequestTypedDict(TypedDict):
...
class DocumentCreateDocumentTemporaryEmailSettingsRequest(BaseModel):
...
class DocumentCreateDocumentTemporaryMeta(BaseModel):
    ...
    distribution_method: Annotated[
        Optional[DocumentCreateDocumentTemporaryDistributionMethodRequest],
    ...
    email_settings: Annotated[
        Optional[DocumentCreateDocumentTemporaryEmailSettingsRequest],
