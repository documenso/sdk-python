...
class DocumentFindDocumentsInternalServerError(DocumensoError):
...
class DocumentFindDocumentsAuthOptionsTypedDict(TypedDict):
    global_access_auth: List[DocumentFindDocumentsGlobalAccessAuth]
    global_action_auth: List[DocumentFindDocumentsGlobalActionAuth]


class DocumentFindDocumentsAuthOptions(BaseModel):
    global_access_auth: Annotated[
        List[DocumentFindDocumentsGlobalAccessAuth],
...
class DocumentFindDocumentsRecipientAuthOptionsTypedDict(TypedDict):
    access_auth: List[DocumentFindDocumentsAccessAuth]
    action_auth: List[DocumentFindDocumentsActionAuth]
...
class DocumentFindDocumentsRecipientAuthOptions(BaseModel):
    ...
    action_auth: Annotated[
        List[DocumentFindDocumentsActionAuth], pydantic.Field(alias="actionAuth")
    ]
