...
class DocumentGetDocumentWithDetailsByIDInternalServerError(DocumensoError):
...
class DocumentGetDocumentWithDetailsByIDNotFoundError(DocumensoError):
    r"""Not found"""
...
class DocumentGetDocumentWithDetailsByIDBadRequestError(DocumensoError):
...
class DocumentGetDocumentWithDetailsByIDAuthOptionsTypedDict(TypedDict):
    global_access_auth: List[DocumentGetDocumentWithDetailsByIDGlobalAccessAuth]
    global_action_auth: List[DocumentGetDocumentWithDetailsByIDGlobalActionAuth]


class DocumentGetDocumentWithDetailsByIDAuthOptions(BaseModel):
    global_access_auth: Annotated[
        List[DocumentGetDocumentWithDetailsByIDGlobalAccessAuth],
...
class DocumentGetDocumentWithDetailsByIDFolderType(str, Enum):
    DOCUMENT = "DOCUMENT"
    TEMPLATE = "TEMPLATE"


class DocumentGetDocumentWithDetailsByIDFolderVisibility(str, Enum):
    EVERYONE = "EVERYONE"
    MANAGER_AND_ABOVE = "MANAGER_AND_ABOVE"
    ADMIN = "ADMIN"


class DocumentGetDocumentWithDetailsByIDFolderTypedDict(TypedDict):
    id: str
    name: str
...
class DocumentGetDocumentWithDetailsByIDFolder(BaseModel):
    id: str
...
class DocumentGetDocumentWithDetailsByIDRecipientAuthOptionsTypedDict(TypedDict):
    access_auth: List[DocumentGetDocumentWithDetailsByIDAccessAuth]
...
class DocumentGetDocumentWithDetailsByIDRecipientAuthOptions(BaseModel):
    access_auth: Annotated[
        List[DocumentGetDocumentWithDetailsByIDAccessAuth],
        pydantic.Field(alias="accessAuth"),
    ]

    action_auth: Annotated[
        List[DocumentGetDocumentWithDetailsByIDActionAuth],
...
class DocumentGetDocumentWithDetailsByIDResponseTypedDict(TypedDict):
    ...
    folder: Nullable[DocumentGetDocumentWithDetailsByIDFolderTypedDict]
...
class DocumentGetDocumentWithDetailsByIDResponse(BaseModel):
    ...
    folder: Nullable[DocumentGetDocumentWithDetailsByIDFolder]
