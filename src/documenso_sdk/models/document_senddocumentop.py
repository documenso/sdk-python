...
class DocumentSendDocumentInternalServerError(DocumensoError):
...
class DocumentSendDocumentBadRequestError(DocumensoError):
...
class DocumentSendDocumentAuthOptionsTypedDict(TypedDict):
    global_access_auth: List[DocumentSendDocumentGlobalAccessAuth]
    global_action_auth: List[DocumentSendDocumentGlobalActionAuth]


class DocumentSendDocumentAuthOptions(BaseModel):
    global_access_auth: Annotated[
        List[DocumentSendDocumentGlobalAccessAuth],
        pydantic.Field(alias="globalAccessAuth"),
    ]

    global_action_auth: Annotated[
        List[DocumentSendDocumentGlobalActionAuth],
